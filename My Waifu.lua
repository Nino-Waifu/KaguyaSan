...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Kaguya Hub BF Premium') then
        makefolder('Kaguya Waifu Hub BF Premium')
    end
    if not _G.Dis and not isfile('Kaguya Waifu Hub BF Premium/'..Name..'.json') then
        writefile('Kaguya Waifu Hub BF Premiem/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Kaguya Waifu Hub BF Premium') and isfile('Kaguya Waifu Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Kaguya Waifu Hub BF Premium/'..Name..'.json'))
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Kaguya Waifu Hub BF Premium') and isfile('Kaguya Waifu BF Premium/'..Name..'.json') then
        writefile('Kaguya Waifu BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Kaguya Waifu Notification", 
        Text = tostring(value),
...
local win = library:Window("Kaguya Waifu",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
